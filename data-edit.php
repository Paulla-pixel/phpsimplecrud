                                    ...
                                    <form action="proses/proses-edit.php" method="POST">
									    <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Lengkap Mahasiswa" value="<?php echo $dataTransaksi['nama']; ?>" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="produk" class="form-label">Produk</label>
                                                <select class="form-select" id="produk" name="produl" required>
                                                    ...
                                                    foreach ($produkList as $produk){
                                                        ...
                                                        if($dataTransaksi['produk'] == $produk['id']){
                                                        ...
                                                        echo '<option value="'.$produk['id'].'" '.$selectedProduk.'>'.$produk['nama'].'</option>';
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="alamat" name="alamat" rows="3" placeholder="Masukkan Alamat Lengkap Sesuai KTP" required><?php echo $Transaksi['alamat']; ?></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label for="pelangga" class="form-label">Pelanggan</label>
                                                <select class="form-select" id="pelanggan" name="pelanggan" required>
                                                    ...
                                                    foreach ($pelangganList as $pelanggan){
                                                        ...
                                                        if($dataTransaksi['pelanggan'] == $pelanggan['id']){
                                                            // Jika sesuai, tandai sebagai opsi yang dipilih
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" id="email" name="email" placeholder="Masukkan Email Valid dan Benar" value="<?php echo $dataTransaksi['email']; ?>" required>
                                            </div>
                                            <div class="mb-3">
