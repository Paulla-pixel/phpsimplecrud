						...
						<div class="row">
							<div class="col-12">
								<div class="card">
									...
									<div class="card-body">
										<p>"Sistem Percetakan Paper Nest dirancang untuk efisiensi maksimal dalam produksi materi promosi dan publikasi. Sistem ini mengintegrasikan teknologi Digital Printing untuk pesanan on-demand dan Offset Konvensional untuk volume tinggi, didukung oleh workflow yang meminimalkan human error. Kami menjamin presisi warna dengan kalibrasi rutin dan menyediakan beragam opsi finishing premium seperti spot UV dan laminasi, memastikan setiap hasil cetak mencerminkan kualitas profesional merek Anda."</p>
